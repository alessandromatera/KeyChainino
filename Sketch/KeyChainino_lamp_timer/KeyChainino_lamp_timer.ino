/*************************************************************************
 * Light Button - FOR KEYCHAININO www.keychainino.com
 * 
 * Turn on all the LEDs by pressing the two button at the same time.
 * 
 * the LEDs will turn off after 5 seconds
 * 
 * the seconds are incremented from the timer overflow interrupt
 *
...
void loop() {
  ...
  /*
   * while seconds is less than 5, we turn on all the LED.
   * seconds is incremented from the timer overflow interrupt.
   */
