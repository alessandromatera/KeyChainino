/*************************************************************************
 * Light Flash - FOR KEYCHAININO www.keychainino.com
 *
 * Blink all the LEDs by pressing the two button at the same time.
 *
 * Turn off all the LEDs by keep pressing one of the two buttons
 *
